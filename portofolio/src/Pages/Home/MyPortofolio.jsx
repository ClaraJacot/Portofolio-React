        ...
        <section className="portofolio--section" id="MyPortofolio">
            <div className="portofolio--container--box">
                <div className="portofolio--container">
                   ...
                   <h2 className="portofolio--section--title">Projets récents</h2> 
                </div>
                <div>
                    <Link to="https://github.com/ClaraJacot?tab=repositories" target="_blank">
                    ...
                    <div key={index} className="portofolio--section--card">
                        ...
                        <div className="portofolio--section--card--content">
                              ...
                              <Link to={item.link} target="_blank">
                                <p className="text-sm portofolio--link">Voir le projet 
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="16"
                                    height="16"
